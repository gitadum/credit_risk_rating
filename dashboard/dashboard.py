...
from api.api import get_app_details, app_db
    ...
    if predict_btn:
        ...
        if req['status_code'] == 404:
            ...
            with main_infos:
                ...
                st.write("PROFESSION : {}".format(req['OCCUPATION_TYPE']['value']))
                st.write("REVENU ANNUEL : {}".format(req['AMT_INCOME_TOTAL']['value']))
